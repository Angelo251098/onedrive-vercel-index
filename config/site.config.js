...
module.exports = {
  ...
  // your email being exposed in public.
   userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'dip69@t.5tb.in',
  ...
  links: [
    {
      name: 'UnionFansub',
      link: 'https://foro.unionfansub.com/member.php?action=profile&uid=159920',
    },
    {
      name: 'Anilist',
      link: 'https://anilist.co/user/Yoange/',
    },
  ],
